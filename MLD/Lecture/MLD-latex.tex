...
To solve  a cube polynomial , we assume a value for the variable where the left side of the equation equals the right side after calculation. Here, for $\lambda = -2$, we get $(-2)^3 - 12(-2) - 16 = 0$.
\end{minipage}
}
\]
